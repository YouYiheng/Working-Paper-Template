...
\available{https://github.com/YouYiheng}
...
\begin{document}
\title{From Steam to Chip: digital adoption and frictional labor market}
\author{You, Yiheng
\thanks{You, Yiheng: UAB Barcelona. We thank colleagues for helpful comments and discussions. This work was supported by a grant [grant number]; another grant [grant number]; and a foundation.}}
\date{Nov. 2023}                       
